...
CREATE TABLE WORKFLOW (ID INTEGER AUTO_INCREMENT NOT NULL, USAGECOUNT INTEGER, CREATEDAT DATETIME, NUMRATING INTEGER, SUMRATING INTEGER, PARENT_ID INTEGER, CREATOR_ID INTEGER, CREATIONTRANSACTION_ID INTEGER, PRIMARY KEY (ID))
