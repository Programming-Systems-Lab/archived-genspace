CREATE TABLE ANALYSISEVENT (ID INTEGER AUTO_INCREMENT NOT NULL, CREATEDAT DATETIME, FINISHEDAT DATETIME, NOTE VARCHAR(255), TRANSACTION_ID INTEGER, TOOL_ID INTEGER, PRIMARY KEY (ID))
...
CREATE TABLE TOOL (ID INTEGER AUTO_INCREMENT NOT NULL, DESCRIPTION VARCHAR(255), MOSTCOMMONPARAMETERS VARCHAR(255), MOSTCOMMONPARAMETERSCOUNT INTEGER, NAME VARCHAR(255), NUMRATING INTEGER, SUMRATING INTEGER, USAGECOUNT INTEGER, WFCOUNTHEAD INTEGER, REPLACEDBY_ID INTEGER, PRIMARY KEY (ID))
CREATE TABLE TOOLSTATCACHE (TOOLID INTEGER NOT NULL, UPDATED DATETIME, MOSTPOPULARBEFORE_ID INTEGER, MOSTPOPULARNEXT_ID INTEGER, PRIMARY KEY (TOOLID))
...
CREATE TABLE IGNOREDHOST (IP INTEGER NOT NULL, COMMENT VARCHAR(255), PRIMARY KEY (IP))
...
ALTER TABLE TOOL ADD CONSTRAINT FK_TOOL_REPLACEDBY_ID FOREIGN KEY (REPLACEDBY_ID) REFERENCES TOOL (ID)
ALTER TABLE TOOLSTATCACHE ADD CONSTRAINT FK_TOOLSTATCACHE_MOSTPOPULARNEXT_ID FOREIGN KEY (MOSTPOPULARNEXT_ID) REFERENCES TOOL (ID)
ALTER TABLE TOOLSTATCACHE ADD CONSTRAINT FK_TOOLSTATCACHE_MOSTPOPULARBEFORE_ID FOREIGN KEY (MOSTPOPULARBEFORE_ID) REFERENCES TOOL (ID)
