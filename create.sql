...
CREATE TABLE SETTING (ID INTEGER AUTO_INCREMENT NOT NULL, data_value VARCHAR(255), data_key VARCHAR(255), PRIMARY KEY (ID))
...
CREATE TABLE WORKFLOWFOLDER (ID INTEGER AUTO_INCREMENT NOT NULL, NAME VARCHAR(255), OWNER_ID INTEGER, PARENT_ID INTEGER, PRIMARY KEY (ID))
CREATE TABLE TRANSACTION (ID INTEGER AUTO_INCREMENT NOT NULL, DATASETNAME VARCHAR(255), CLIENTID VARCHAR(255), HOSTNAME VARCHAR(255), DATE DATETIME, WORKFLOW_ID INTEGER, USER_ID INTEGER, PRIMARY KEY (ID))
CREATE TABLE TOOLRATING (ID INTEGER AUTO_INCREMENT NOT NULL, CREATEDAT DATETIME, RATING INTEGER, CREATOR_ID INTEGER, TOOL_ID INTEGER, PRIMARY KEY (ID))
...
CREATE TABLE Friend (ID INTEGER AUTO_INCREMENT NOT NULL, MUTUAL TINYINT(1) default 0, VISIBLE TINYINT(1) default 0, id_2 INTEGER, id_1 INTEGER, PRIMARY KEY (ID))
CREATE TABLE registration (ID INTEGER AUTO_INCREMENT NOT NULL, PHONE VARCHAR(50), INTERESTS TEXT(64000), STATE VARCHAR(50), online_status INTEGER, PASSWORD VARCHAR(50) NOT NULL, CITY VARCHAR(50), USERNAME VARCHAR(50) NOT NULL, CREATEDAT DATETIME, first_name VARCHAR(50) NOT NULL, DATAVISIBILITY INTEGER, work_title VARCHAR(50), last_name VARCHAR(50) NOT NULL, ZIPCODE VARCHAR(7), lab_affiliation VARCHAR(100) NOT NULL, ADDR1 VARCHAR(50), ADDR2 VARCHAR(50), EMAIL VARCHAR(50), LOGDATA INTEGER, ROOTFOLDER_ID INTEGER, PRIMARY KEY (ID))
...
CREATE TABLE TOOLCOMMENT (ID INTEGER AUTO_INCREMENT NOT NULL, CREATEDAT DATETIME, COMMENT VARCHAR(255), CREATOR_ID INTEGER, TOOL_ID INTEGER, PRIMARY KEY (ID))
CREATE TABLE INCOMINGWORKFLOW (ID INTEGER AUTO_INCREMENT NOT NULL, CREATEDAT DATETIME, NAME VARCHAR(255), SENDER_ID INTEGER, RECEIVER_ID INTEGER, WORKFLOW_ID INTEGER, PRIMARY KEY (ID))
CREATE TABLE NETWORK (ID INTEGER AUTO_INCREMENT NOT NULL, NAME VARCHAR(255), owner INTEGER, PRIMARY KEY (ID))
CREATE TABLE WORKFLOW (ID INTEGER AUTO_INCREMENT NOT NULL, USAGECOUNT INTEGER, CREATEDAT DATETIME, NUMRATING INTEGER, SUMRATING INTEGER, CREATOR_ID INTEGER, CREATIONTRANSACTION_ID INTEGER, PARENT_ID INTEGER, PRIMARY KEY (ID))
...
CREATE TABLE User_Network (ID INTEGER AUTO_INCREMENT NOT NULL, VISIBLE TINYINT(1) default 0, VERIFIED TINYINT(1) default 0, user_id INTEGER, network_id INTEGER, PRIMARY KEY (ID))
