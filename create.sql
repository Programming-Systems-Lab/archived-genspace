CREATE TABLE ANALYSISEVENT (ID INTEGER AUTO_INCREMENT NOT NULL, CREATEDAT DATETIME, NOTE VARCHAR(255), TRANSACTION_ID INTEGER, TOOL_ID INTEGER, PRIMARY KEY (ID))
