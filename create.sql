...
CREATE TABLE WORKFLOW (ID INTEGER AUTO_INCREMENT NOT NULL, USAGECOUNT INTEGER, CREATEDAT DATETIME, NUMRATING INTEGER, SUMRATING INTEGER, PARENT_ID INTEGER, CREATIONTRANSACTION_ID INTEGER, CREATOR_ID INTEGER, PRIMARY KEY (ID))
CREATE TABLE INCOMINGWORKFLOW (ID INTEGER AUTO_INCREMENT NOT NULL, CREATEDAT DATETIME, NAME VARCHAR(255), RECEIVER_ID INTEGER, WORKFLOW_ID INTEGER, SENDER_ID INTEGER, PRIMARY KEY (ID))
...
CREATE TABLE USERWORKFLOW (ID INTEGER AUTO_INCREMENT NOT NULL, CREATEDAT DATETIME, NAME VARCHAR(255), OWNER_ID INTEGER, FOLDER_ID INTEGER, WORKFLOW_ID INTEGER, PRIMARY KEY (ID))
CREATE TABLE WORKFLOWCOMMENT (ID INTEGER AUTO_INCREMENT NOT NULL, CREATEDAT DATETIME, COMMENT VARCHAR(255), CREATOR_ID INTEGER, WORKFLOW_ID INTEGER, PRIMARY KEY (ID))
