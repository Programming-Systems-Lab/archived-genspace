...
CREATE TABLE USERWORKFLOW (ID INTEGER AUTO_INCREMENT NOT NULL, CREATEDAT DATETIME, NAME VARCHAR(255), WORKFLOW_ID INTEGER, OWNER_ID INTEGER, FOLDER_ID INTEGER, PRIMARY KEY (ID))
