...
/**
 * The rosterpanel actually contains the roster, as the rosterframe also
...
public class RosterPanel extends javax.swing.JPanel implements RosterListener {
	...
	private class RosterModel extends AbstractListModel {
		...
		public Object getElementAt(int index) {
			...
			return "<html><body><font color=\"" + color + "\"><b>"
					+ entries.get(keys.get(index)).getName()
					+ "</b></font></body></html>";
	...
	private void lstRosterMouseClicked(java.awt.event.MouseEvent evt) {
		if (evt.getClickCount() == 2) {
			...
			Chat c = ChatReceiver.manager.createChat(
					((RosterModel) (lstRoster.getModel())).getEntry(
							lstRoster.getSelectedIndex()).getUser(), null);
	...
	private void initComponents() {
		...
		layout.setVerticalGroup(layout.createParallelGroup(
				org.jdesktop.layout.GroupLayout.LEADING).add(jScrollPane3,
				org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 337,
				org.jdesktop.layout.GroupLayout.PREFERRED_SIZE));
	}// </editor-fold>
