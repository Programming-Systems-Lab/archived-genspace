...
/**
 * Based on org.geworkbench.builtin.projects.ProjectPanel
 * Displays workflows saved in the repository of a user, in a tree-based folder hierarchy
 * TODO: the folder hierarchy is not completed
 * @author flavio
 *
 */
