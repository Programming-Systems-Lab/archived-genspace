...
//		Now actually do the layout, then recreate the display graph using the calculated co-ords.
	...
	public class GraphListener implements GraphModelListener, GraphSelectionListener
	{
		JPanel parent;
		...
		public void valueChanged(GraphSelectionEvent e)
		{
			...
			if (o instanceof GraphNode)
			{
				...
				if(workflowString != null){
					...
					toolsInWorkflow = DomainUtil.fromWorkflowStringToList(workflowString);
				}
				popup.initialize(selectedNode.getToolName(), toolsInWorkflow);
				popup.show(GraphPanel.this, (int)rect.getCenterX(), (int)rect.getCenterY());
			}
			/*
