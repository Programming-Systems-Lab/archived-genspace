...
public class DomainUtil {
	...
	/**
	 * Given a list of tools (e.g., the sequence of tools in a workflow), it returns a string that identifies such list uniquely
	 * toolA,toolB,toolC,toolD     
	 * to be used as a workflow identifier and to generate hashcode
	 * @param tools
	 * @return
	 */
