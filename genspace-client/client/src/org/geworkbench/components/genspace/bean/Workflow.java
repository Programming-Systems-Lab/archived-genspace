...
public class Workflow implements Serializable {
	...
	public int ID; //the ID may not always be available if not explicitly loaded from the DB
	...
	//In the DB there is a tree-like representation of the workflows in the "workflows table"
	//a workflow is a sequence of nodes where each node is a pair (parent, workflow, toolname)
	//a general sequence is (-1, workflow1, toolname1) -> (workflow1, workflow2, toolname2) -> and so on
	//the workflows ids are kept in this array, the parent id is -1 for the first one or the id of the prev node
	...
	public String toString(){
		return ID+" "+creatorUsername+" "+creationDate+" "+creationTransactionId+" "+usageCount+" "+tools.size();
	}
