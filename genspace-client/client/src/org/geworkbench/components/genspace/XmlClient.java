...
public class XmlClient {
	...
	/**
	 * A very simple method that just sends the data as an entire line to the
	 * server.
	 */
	 ...
	 * 
	 * @param filename
	 *            the full path to the file to send to the server
	 */
	...
	public static void main(String[] args) {
		if (args.length < 3) {
			System.out
					.println("Please specify the host name, port number and file name!");
			System.exit(0);
		}
