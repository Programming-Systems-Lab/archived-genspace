...
/**
 * Base class that represents a row from the 'network_visibility' table.
 *
 * 
 *
...
abstract class BaseNetworkVisibility extends BaseObject  implements Persistent
{
	 ...
	 * Peer class name
	 */
  const PEER = 'NetworkVisibilityPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        NetworkVisibilityPeer
	 */
	...
	/**
	 * The value for the user_data_option field.
	 * @var        int
	 */
	protected $user_data_option;

	/**
	 * The value for the networkname field.
	 * @var        string
	 */
	...
	/**
	 * Get the [user_data_option] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Get the [networkname] column value.
	 * 
	 * @return     string
	 */
	 ...
	 * @return     NetworkVisibility The current object (for fluent API support)
	 */
	...
	/**
	 * Set the value of [user_data_option] column.
	 * 
	 * @param      int $v new value
	 * @return     NetworkVisibility The current object (for fluent API support)
	 */
	...
	/**
	 * Set the value of [networkname] column.
	 * 
	 * @param      string $v new value
	 * @return     NetworkVisibility The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->user_data_option = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->networkname = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->resetModified();
			...
			return $startcol + 4; // 4 = NetworkVisibilityPeer::NUM_COLUMNS - NetworkVisibilityPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function ensureConsistency()
	{
		...
		if ($this->aRegistration !== null && $this->username !== $this->aRegistration->getUsername()) {
			$this->aRegistration = null;
		}
	} // ensureConsistency
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = NetworkVisibilityPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				NetworkVisibilityPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(NetworkVisibilityPeer::ID) ) {
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of NetworkVisibility (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     NetworkVisibility Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getRegistration(PropelPDO $con = null)
	{
		if ($this->aRegistration === null && (($this->username !== "" && $this->username !== null))) {
			$this->aRegistration = RegistrationQuery::create()->findPk($this->username, $con);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aRegistration->addNetworkVisibilitys($this);
			 */
		}
