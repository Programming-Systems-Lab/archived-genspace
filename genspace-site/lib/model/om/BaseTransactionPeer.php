...
abstract class BaseTransactionPeer {
	...
	/** the column name for the DATASETNAME field */
	const DATASETNAME = 'TRANSACTION.DATASETNAME';

	/** the column name for the CLIENTID field */
	const CLIENTID = 'TRANSACTION.CLIENTID';

	/** the column name for the HOSTNAME field */
	const HOSTNAME = 'TRANSACTION.HOSTNAME';
	...
	const WORKFLOW_ID = 'TRANSACTION.WORKFLOW_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Datasetname', 'Clientid', 'Hostname', 'Date', 'UserId', 'WorkflowId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'datasetname', 'clientid', 'hostname', 'date', 'userId', 'workflowId', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::DATASETNAME, self::CLIENTID, self::HOSTNAME, self::DATE, self::USER_ID, self::WORKFLOW_ID, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'DATASETNAME', 'CLIENTID', 'HOSTNAME', 'DATE', 'USER_ID', 'WORKFLOW_ID', ),
		BasePeer::TYPE_FIELDNAME => array ('ID', 'DATASETNAME', 'CLIENTID', 'HOSTNAME', 'DATE', 'USER_ID', 'WORKFLOW_ID', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Datasetname' => 1, 'Clientid' => 2, 'Hostname' => 3, 'Date' => 4, 'UserId' => 5, 'WorkflowId' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'datasetname' => 1, 'clientid' => 2, 'hostname' => 3, 'date' => 4, 'userId' => 5, 'workflowId' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::DATASETNAME => 1, self::CLIENTID => 2, self::HOSTNAME => 3, self::DATE => 4, self::USER_ID => 5, self::WORKFLOW_ID => 6, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'DATASETNAME' => 1, 'CLIENTID' => 2, 'HOSTNAME' => 3, 'DATE' => 4, 'USER_ID' => 5, 'WORKFLOW_ID' => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('ID' => 0, 'DATASETNAME' => 1, 'CLIENTID' => 2, 'HOSTNAME' => 3, 'DATE' => 4, 'USER_ID' => 5, 'WORKFLOW_ID' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(TransactionPeer::DATASETNAME);
			$criteria->addSelectColumn(TransactionPeer::CLIENTID);
			$criteria->addSelectColumn(TransactionPeer::HOSTNAME);
			$criteria->addSelectColumn(TransactionPeer::DATE);
			$criteria->addSelectColumn(TransactionPeer::USER_ID);
			$criteria->addSelectColumn(TransactionPeer::WORKFLOW_ID);
		} else {
			$criteria->addSelectColumn($alias . '.ID');
			$criteria->addSelectColumn($alias . '.DATASETNAME');
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = TransactionPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + TransactionPeer::NUM_COLUMNS;
		} else {
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		$criteria->remove(TransactionPeer::ID);
