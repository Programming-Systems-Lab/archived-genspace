...
abstract class BaseWorkflowRatingsPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (WorkflowRatingsPeer::PK, WorkflowRatingsPeer::ID, WorkflowRatingsPeer::USERNAME, WorkflowRatingsPeer::RATING, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (WorkflowRatingsPeer::PK => 0, WorkflowRatingsPeer::ID => 1, WorkflowRatingsPeer::USERNAME => 2, WorkflowRatingsPeer::RATING => 3, ),
	...
	{
		return BasePeer::getMapBuilder('lib.model.map.WorkflowRatingsMapBuilder');
	}
	
	public static function getPhpNameMap()
	{
		if (self::$phpNameMap === null) {
			$map = WorkflowRatingsPeer::getTableMap();
	...
	const COUNT = 'COUNT(workflow_ratings.PK)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT workflow_ratings.PK)';
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		if ($distinct || in_array(Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(WorkflowRatingsPeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(WorkflowRatingsPeer::COUNT);
		}
		...
		$rs = WorkflowRatingsPeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
						return 0;
	...
	{
		return WorkflowRatingsPeer::populateObjects(WorkflowRatingsPeer::doSelectRS($criteria, $con));
	}
	...
	public static function populateObjects(ResultSet $rs)
	{
		$results = array();
				...
				$cls = WorkflowRatingsPeer::getOMClass();
  ...
  static public function getUniqueColumnNames()
  {
	...
	{
		return WorkflowRatingsPeer::CLASS_DEFAULT;
	}
	...
	public static function doUpdate($values, $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(WorkflowRatingsPeer::PK, $criteria->remove(WorkflowRatingsPeer::PK), $comparison);
	...
	public static function doDeleteAll($con = null)
	{
		...
		$affectedRows = 0; 		try {
									$con->begin();
			$affectedRows += BasePeer::doDeleteAll(WorkflowRatingsPeer::TABLE_NAME, $con);
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollback();
	 ...
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			$criteria = clone $values; 		} elseif ($values instanceof WorkflowRatings) {
	...
	public static function doValidate(WorkflowRatings $obj, $cols = null)
	{
		...
		$res =  BasePeer::doValidate(WorkflowRatingsPeer::DATABASE_NAME, WorkflowRatingsPeer::TABLE_NAME, $columns);
    if ($res !== true) {
        $request = sfContext::getInstance()->getRequest();
        foreach ($res as $failed) {
            $col = WorkflowRatingsPeer::translateFieldname($failed->getColumn(), BasePeer::TYPE_COLNAME, BasePeer::TYPE_PHPNAME);
...
if (Propel::isInit()) {
			try {
		BaseWorkflowRatingsPeer::getMapBuilder();
	} catch (Exception $e) {
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
	}
} else {
			Propel::registerMapBuilder('lib.model.map.WorkflowRatingsMapBuilder');
}
