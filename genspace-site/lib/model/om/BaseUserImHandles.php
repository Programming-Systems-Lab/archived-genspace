...
/**
 * Base class that represents a row from the 'user_IM_handles' table.
 *
 * 
 *
...
abstract class BaseUserImHandles extends BaseObject  implements Persistent
{
	 ...
	 * Peer class name
	 */
  const PEER = 'UserImHandlesPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        UserImHandlesPeer
	 */
	...
	/**
	 * The value for the im_handle field.
	 * @var        string
	 */
	protected $im_handle;

	/**
	 * The value for the im_service field.
	 * @var        string
	 */
	...
	/**
	 * Get the [im_handle] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Get the [im_service] column value.
	 * 
	 * @return     string
	 */
	 ...
	 * @return     UserImHandles The current object (for fluent API support)
	 */
	...
	/**
	 * Set the value of [im_handle] column.
	 * 
	 * @param      string $v new value
	 * @return     UserImHandles The current object (for fluent API support)
	 */
	...
	/**
	 * Set the value of [im_service] column.
	 * 
	 * @param      string $v new value
	 * @return     UserImHandles The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->im_handle = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->im_service = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			...
			return $startcol + 4; // 4 = UserImHandlesPeer::NUM_COLUMNS - UserImHandlesPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = UserImHandlesPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				UserImHandlesPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(UserImHandlesPeer::ID) ) {
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of UserImHandles (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     UserImHandles Clone of current object.
	 * @throws     PropelException
	 */
