  ...
  const PEER = 'FriendsPeer';
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->user1 = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
			$this->user2 = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			...
			return $startcol + 3; // 3 = FriendsPeer::NUM_COLUMNS - FriendsPeer::NUM_LAZY_LOAD_COLUMNS).
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(FriendsPeer::ID) ) {
