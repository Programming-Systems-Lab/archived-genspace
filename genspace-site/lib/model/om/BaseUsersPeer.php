...
abstract class BaseUsersPeer {
	...
	const ORGANIZATION = 'users.ORGANIZATION';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Username', 'Password', 'Email', 'Organization', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'username', 'password', 'email', 'organization', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USERNAME, self::PASSWORD, self::EMAIL, self::ORGANIZATION, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USERNAME', 'PASSWORD', 'EMAIL', 'ORGANIZATION', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'username', 'password', 'email', 'organization', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Username' => 1, 'Password' => 2, 'Email' => 3, 'Organization' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'username' => 1, 'password' => 2, 'email' => 3, 'organization' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USERNAME => 1, self::PASSWORD => 2, self::EMAIL => 3, self::ORGANIZATION => 4, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USERNAME' => 1, 'PASSWORD' => 2, 'EMAIL' => 3, 'ORGANIZATION' => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'username' => 1, 'password' => 2, 'email' => 3, 'organization' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(UsersPeer::ORGANIZATION);
		} else {
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = UsersPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + UsersPeer::NUM_COLUMNS;
		} else {
