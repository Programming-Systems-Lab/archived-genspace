...
abstract class BaseUsersPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (UsersPeer::ID, UsersPeer::USERNAME, UsersPeer::PASSWORD, UsersPeer::EMAIL, UsersPeer::ORGANIZATION, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (UsersPeer::ID => 0, UsersPeer::USERNAME => 1, UsersPeer::PASSWORD => 2, UsersPeer::EMAIL => 3, UsersPeer::ORGANIZATION => 4, ),
  ...
  static public function getUniqueColumnNames()
  {
	...
	public static function doDeleteAll($con = null)
	{
	 ...
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			$criteria = clone $values; 		} elseif ($values instanceof Users) {
