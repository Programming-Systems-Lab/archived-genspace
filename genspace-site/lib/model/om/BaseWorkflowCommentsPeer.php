...
abstract class BaseWorkflowCommentsPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (WorkflowCommentsPeer::PK, WorkflowCommentsPeer::ID, WorkflowCommentsPeer::COMMENT, WorkflowCommentsPeer::USERNAME, WorkflowCommentsPeer::POSTED_ON, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (WorkflowCommentsPeer::PK => 0, WorkflowCommentsPeer::ID => 1, WorkflowCommentsPeer::COMMENT => 2, WorkflowCommentsPeer::USERNAME => 3, WorkflowCommentsPeer::POSTED_ON => 4, ),
	...
	{
		return BasePeer::getMapBuilder('lib.model.map.WorkflowCommentsMapBuilder');
	}
	
	public static function getPhpNameMap()
	{
		if (self::$phpNameMap === null) {
			$map = WorkflowCommentsPeer::getTableMap();
	...
	const COUNT = 'COUNT(workflow_comments.PK)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT workflow_comments.PK)';
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		if ($distinct || in_array(Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(WorkflowCommentsPeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(WorkflowCommentsPeer::COUNT);
		}
		...
		$rs = WorkflowCommentsPeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
						return 0;
	...
	{
		return WorkflowCommentsPeer::populateObjects(WorkflowCommentsPeer::doSelectRS($criteria, $con));
	}
	...
	public static function populateObjects(ResultSet $rs)
	{
		$results = array();
				...
				$cls = WorkflowCommentsPeer::getOMClass();
  ...
  static public function getUniqueColumnNames()
  {
	...
	{
		return WorkflowCommentsPeer::CLASS_DEFAULT;
	}
	...
	public static function doUpdate($values, $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(WorkflowCommentsPeer::PK, $criteria->remove(WorkflowCommentsPeer::PK), $comparison);
	...
	public static function doDeleteAll($con = null)
	{
		...
		$affectedRows = 0; 		try {
									$con->begin();
			$affectedRows += BasePeer::doDeleteAll(WorkflowCommentsPeer::TABLE_NAME, $con);
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollback();
	 ...
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			$criteria = clone $values; 		} elseif ($values instanceof WorkflowComments) {
	...
	public static function doValidate(WorkflowComments $obj, $cols = null)
	{
		...
		$res =  BasePeer::doValidate(WorkflowCommentsPeer::DATABASE_NAME, WorkflowCommentsPeer::TABLE_NAME, $columns);
    if ($res !== true) {
        $request = sfContext::getInstance()->getRequest();
        foreach ($res as $failed) {
            $col = WorkflowCommentsPeer::translateFieldname($failed->getColumn(), BasePeer::TYPE_COLNAME, BasePeer::TYPE_PHPNAME);
...
if (Propel::isInit()) {
			try {
		BaseWorkflowCommentsPeer::getMapBuilder();
	} catch (Exception $e) {
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
	}
} else {
			Propel::registerMapBuilder('lib.model.map.WorkflowCommentsMapBuilder');
}
