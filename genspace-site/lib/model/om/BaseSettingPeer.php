...
abstract class BaseSettingPeer {
	...
	/** the column name for the DATA_VALUE field */
	const DATA_VALUE = 'setting.DATA_VALUE';

	/** the column name for the DATA_KEY field */
	const DATA_KEY = 'setting.DATA_KEY';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'DataValue', 'DataKey', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'dataValue', 'dataKey', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::DATA_VALUE, self::DATA_KEY, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'DATA_VALUE', 'DATA_KEY', ),
		BasePeer::TYPE_FIELDNAME => array ('ID', 'data_value', 'data_key', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'DataValue' => 1, 'DataKey' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'dataValue' => 1, 'dataKey' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::DATA_VALUE => 1, self::DATA_KEY => 2, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'DATA_VALUE' => 1, 'DATA_KEY' => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('ID' => 0, 'data_value' => 1, 'data_key' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(SettingPeer::DATA_VALUE);
			$criteria->addSelectColumn(SettingPeer::DATA_KEY);
		} else {
			$criteria->addSelectColumn($alias . '.ID');
			$criteria->addSelectColumn($alias . '.DATA_VALUE');
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = SettingPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + SettingPeer::NUM_COLUMNS;
		} else {
