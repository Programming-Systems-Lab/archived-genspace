...
abstract class BaseAnnotationPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Wspid', 'Annotation', 'Creator', 'Createdat', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'wspid', 'annotation', 'creator', 'createdat', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::WSPID, self::ANNOTATION, self::CREATOR, self::CREATEDAT, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'WSPID', 'ANNOTATION', 'CREATOR', 'CREATEDAT', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'wspid', 'annotation', 'creator', 'createdAt', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Wspid' => 1, 'Annotation' => 2, 'Creator' => 3, 'Createdat' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'wspid' => 1, 'annotation' => 2, 'creator' => 3, 'createdat' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::WSPID => 1, self::ANNOTATION => 2, self::CREATOR => 3, self::CREATEDAT => 4, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'WSPID' => 1, 'ANNOTATION' => 2, 'CREATOR' => 3, 'CREATEDAT' => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'wspid' => 1, 'annotation' => 2, 'creator' => 3, 'createdAt' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(AnnotationPeer::WSPID);
			$criteria->addSelectColumn(AnnotationPeer::ANNOTATION);
			$criteria->addSelectColumn(AnnotationPeer::CREATOR);
			$criteria->addSelectColumn(AnnotationPeer::CREATEDAT);
		} else {
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = AnnotationPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + AnnotationPeer::NUM_COLUMNS;
		} else {
	...
	public static function doCountJoinWorkspace(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(AnnotationPeer::WSPID, WorkspacePeer::ID, $join_behavior);
	...
	public static function doCountJoinRegistration(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(AnnotationPeer::CREATOR, RegistrationPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Annotation objects pre-filled with their Workspace objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinWorkspace(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		AnnotationPeer::addSelectColumns($criteria);
		$startcol = (AnnotationPeer::NUM_COLUMNS - AnnotationPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Annotation) to $obj2 (Workspace)
	...
	/**
	 * Selects a collection of Annotation objects pre-filled with their Registration objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Annotation objects.
	...
	public static function doSelectJoinRegistration(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Annotation) to $obj2 (Registration)
				$obj2->addAnnotation($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		AnnotationPeer::addSelectColumns($criteria);
		$startcol2 = (AnnotationPeer::NUM_COLUMNS - AnnotationPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Annotation) to the collection in $obj2 (Workspace)
				$obj2->addAnnotation($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Annotation) to the collection in $obj3 (Registration)
				$obj3->addAnnotation($obj1);
			} // if joined row not null
	...
	/**
	 * Selects a collection of Annotation objects pre-filled with all related objects except Workspace.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAllExceptWorkspace(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = AnnotationPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (Annotation) to the collection in $obj2 (Registration)
				$obj2->addAnnotation($obj1);
	...
	/**
	 * Selects a collection of Annotation objects pre-filled with all related objects except Registration.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		$criteria->remove(AnnotationPeer::ID);
