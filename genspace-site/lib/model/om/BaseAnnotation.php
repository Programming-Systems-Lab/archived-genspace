...
abstract class BaseAnnotation extends BaseObject  implements Persistent
{
  ...
  const PEER = 'AnnotationPeer';
	...
	public function setWspid($v)
	{
		...
		if ($this->wspid !== $v) {
			$this->wspid = $v;
			$this->modifiedColumns[] = AnnotationPeer::WSPID;
		}
	...
	public function setAnnotation($v)
	{
		...
		if ($this->annotation !== $v) {
			$this->annotation = $v;
			$this->modifiedColumns[] = AnnotationPeer::ANNOTATION;
		}
	...
	public function setCreator($v)
	{
		...
		if ($this->creator !== $v) {
			$this->creator = $v;
			$this->modifiedColumns[] = AnnotationPeer::CREATOR;
		}
	...
	public function setCreatedat($v)
	{
		...
		if ( $this->createdat !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = AnnotationPeer::CREATEDAT;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->annotation = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->creator = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			...
			return $startcol + 5; // 5 = AnnotationPeer::NUM_COLUMNS - AnnotationPeer::NUM_LAZY_LOAD_COLUMNS).
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(AnnotationPeer::ID) ) {
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setAnnotation($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AnnotationPeer::WSPID)) $criteria->add(AnnotationPeer::WSPID, $this->wspid);
		if ($this->isColumnModified(AnnotationPeer::ANNOTATION)) $criteria->add(AnnotationPeer::ANNOTATION, $this->annotation);
		if ($this->isColumnModified(AnnotationPeer::CREATOR)) $criteria->add(AnnotationPeer::CREATOR, $this->creator);
		if ($this->isColumnModified(AnnotationPeer::CREATEDAT)) $criteria->add(AnnotationPeer::CREATEDAT, $this->createdat);
	...
	public function getWorkspace(PropelPDO $con = null)
	{
		if ($this->aWorkspace === null && ($this->wspid !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aWorkspace->addAnnotations($this);
			 */
		}
	...
	public function getRegistration(PropelPDO $con = null)
	{
		if ($this->aRegistration === null && ($this->creator !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aRegistration->addAnnotations($this);
			 */
		}
