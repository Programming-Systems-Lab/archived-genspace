...
/**
 * This class defines the structure of the 'analysis_events' table.
 *
 *
 *
 ...
 */
class AnalysisEventsTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.AnalysisEventsTableMap';
	...
	{
	  // attributes
		$this->setName('analysis_events');
		$this->setPhpName('AnalysisEvents');
		$this->setClassname('AnalysisEvents');
