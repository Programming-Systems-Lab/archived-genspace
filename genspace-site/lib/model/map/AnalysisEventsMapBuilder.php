...
class AnalysisEventsMapBuilder {

	
	const CLASS_NAME = 'lib.model.map.AnalysisEventsMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('analysis_events');
		$tMap->setPhpName('AnalysisEvents');
