 ...
 * 
 */
@WebServiceClient(name = "PublicFacadeService", targetNamespace = "http://server.genspace.components.geworkbench.org/", wsdlLocation = "http://:8080/PublicFacadeService/PublicFacade?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "http://:8080/PublicFacadeService/PublicFacade?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://:8080/PublicFacadeService/PublicFacade?wsdl', retrying as a local file");
