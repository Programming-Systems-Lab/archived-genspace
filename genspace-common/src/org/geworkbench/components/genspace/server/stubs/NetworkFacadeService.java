 ...
 * 
 */
@WebServiceClient(name = "NetworkFacadeService", targetNamespace = "http://server.genspace.components.geworkbench.org/", wsdlLocation = "http://genspace.cs.columbia.edu:8080/NetworkFacadeService/NetworkFacade?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "http://genspace.cs.columbia.edu:8080/NetworkFacadeService/NetworkFacade?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://genspace.cs.columbia.edu:8080/NetworkFacadeService/NetworkFacade?wsdl', retrying as a local file");
