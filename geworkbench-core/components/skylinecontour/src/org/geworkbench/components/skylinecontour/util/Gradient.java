...
package org.geworkbench.components.skylinecontour.util;
...
var defaultColour = "#550000";

        */
        
        gradient.addPoint(new Color(0xff,0xff,0xff));
        gradient.addPoint(new Color(0xff,0xff,0x00));
        gradient.addPoint(new Color(0xff,0x8c,0x00));
        gradient.addPoint(new Color(0xff,0x45,0x00));
        gradient.addPoint(new Color(0xff,0x00,0x00));
        gradient.addPoint(new Color(0x55,0x00,0x00));
